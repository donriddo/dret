...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(
            msg.sender == _owner,
            "Only owner of contract can perform this operation"
        );
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(!newOwner.isContract(), "Only an EOA can own this contract");
        _owner = newOwner;
...
contract Pausable is Ownable {
    ...
    function setPausedState(bool _pausedState) public onlyOwner {
        require(
            _paused != _pausedState,
            "Paused state cannot be the same as current state"
        );
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            ...
            "You cannot approve owner of token"
        );
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(
            owner() == msg.sender || isApprovedForAll(_tokenOwner[tokenId], to),
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        require(
            !to.isContract() && !_exists(tokenId),
            "Token already minted or owner address is invalid"
        );
    ...
    function _transferFrom(
        ...
        require(
            ...
            "Only owner of token can transfer it"
        );
...
contract DRET is ERC721Metadata {
    constructor()
        public
        ERC721Metadata(
            "Donriddo Real Estate Token",
            "DRET",
